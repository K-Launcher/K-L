...
public class WindowsTM extends JFrame {
	 ...
	 */
	public WindowsTM() {
		setTitle("K-Launcher (Windows)");
		setIconImage(Toolkit.getDefaultToolkit().getImage(WindowsTM.class.getResource("/javax/swing/plaf/basic/icons/K-L-icon-png.png")));
		...
		JButton btnNewButton = new JButton("KSP2 mode");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				System.out.println("Swapping to KSPII mode");
				try {
					Thread.sleep(1000);
